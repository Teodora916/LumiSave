...
export const LoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Prijavljivanje nije uspelo.";
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-display font-bold text-white leading-tight mb-6">
            Uštedite do <span className="text-accent">80%</span>
            <br />
            na računu za struju
          </h2>
          <p className="text-white/70 text-lg leading-relaxed">
            Prijavite se i pristupite kalkulatorima, personalizovanim
            preporukama i ekskluzivnim cenama.
          </p>
